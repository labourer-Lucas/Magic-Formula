...
stock_data = pd.read_csv("data/Russell-3000.csv")#Read Russell 3000 holdings
...
print(df)
file_path = "result/magic_formula_rank_"+timeStamp +".xlsx" # Replace with your desired file path
